...
Injected once in app.py before st.navigation().run() so the styles
apply to every page in the same browser session.
...
def get_global_css() -> str:
    ...
    Usage:
        ...
        from streamlit_app.components.styles import get_global_css
